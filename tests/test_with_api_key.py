#!/usr/bin/env python3
"""
Test script for email assistant with explicit API key
"""
...
def test_with_api_key():
    """Test the email assistant with a sample email and explicit API key"""
    ...
    print("Testing email assistant with sample email and API key...")
