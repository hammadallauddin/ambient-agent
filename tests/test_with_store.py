#!/usr/bin/env python3
"""
Test script for the email assistant with proper store handling
"""
...
def test_email_assistant_with_store():
    """Test the email assistant with a sample email using in-memory store"""
...
if __name__ == "__main__":
    success = test_email_assistant_with_store()
    if success:
